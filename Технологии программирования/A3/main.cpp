...
int main()
{
  try
  {
    ...
    std::cout << "'" << rotateAngle << "' rotate result: " << '\n';
    test_rectangle.rotate(rotateAngle);
    test_rectangle.show();
    std::cout << "\n\n";
    
    
    std::cout << "Composite shapes:\n" << "===================";
    potapova::Rectangle test_rectangle1({{5, 5}, 10, 5});
    potapova::Circle test_circle1({3, 3}, 1);
    ...
    shapes.scale(2);
    shapes.show();
    std::cout << "\n\nComposite shapes after deleting second shape (circle):";
    shapes.removeShape(index);
    shapes.show();
    std::cout << "\n\nRotating (" << rotateAngle << ")\n" << "===================";
    shapes.rotate(rotateAngle);
    shapes.show();
    std::cout << "\n\n";
